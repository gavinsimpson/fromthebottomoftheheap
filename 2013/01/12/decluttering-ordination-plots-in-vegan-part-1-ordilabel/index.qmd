...
description: >-
  In an earlier post I showed how to customise ordination diagrams produced by our vegan package
  for R through use of colours and plotting symbols. In a series of short posts I want to cover
  some of the options available in vegan that can be used to help in producing better, clearer,
  less cluttered ordination diagrams. First up we have ordilabel().
...
![PCA biplot of the dune meadow data with labels added by `ordilabel()`](/assets/img/posts/ordilabel_figure_combined.png)
...
<span>[← Older: Shading regions under a curve](/2013/01/11/shading-regions-under-a-curve/)</span>
<span class="text-end">[Newer: Decluttering ordination plots in vegan part 2: orditorp() →](/2013/01/13/decluttering-ordination-plots-in-vegan-part-2-orditorp/)</span>
:::
