...
description: >-
  Over on the Clastic Detritus blog, Brian Romans posted a nice introduction to plotting in R. At
  the end of his post, Brian mentioned he would like to colour in areas under the data curve
  corresponding to particular ranges of grain sizes. The comment area on a blog isn't really
  amenable to giving a full answer to the problem posed so I gave a few pointers. Other
  commenters also suggested solutions.
...
#### Tagged
[Area under a curve](/tag/area-under-a-curve/){.badge .text-bg-dark}
[Graphics](/tag/graphics/){.badge .text-bg-dark}
[Plotting](/tag/plotting/){.badge .text-bg-dark}
[Polygon](/tag/polygon/){.badge .text-bg-dark}
...
![Example data used to illustrate shading areas under a curve](/assets/img/posts/polygon_under_curve_data_figure_1.png)
...
![Final plot showing the example data and four regions under the curve shaded](/assets/img/posts/final_plot_polygon_under_the_curve.png)
...
![Illustrating the steps involved in interpolating the data curve and drawing a polygon under the curve](/assets/img/posts/working_polygon_under_curve.png)
...
<span>[← Older: Monotonic deshrinking in weighted averaging models](/2013/01/05/monotonic-deshrinking-in-weighted-averaging-models/)</span>
<span class="text-end">[Newer: Decluttering ordination plots in vegan part 1: ordilabel() →](/2013/01/12/decluttering-ordination-plots-in-vegan-part-1-ordilabel/)</span>
:::
