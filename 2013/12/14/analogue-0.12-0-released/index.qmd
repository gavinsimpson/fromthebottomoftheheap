...
tags:
  ...
  - timetrack
category: R
description: It has been almost a year since the last release of the analogue package.
  At lot has happened in the intervening period and although I've been busy with a
  new job in a new country and coding on several other R packages, activity on analogue
  has also progressed a pace. As the ver…
