...
description: >-
  Ordination methods that yield orthogonal axes of variation are often used to summarise the
  multivariate data obtained from sediment cores. Usually the first or, less often, the first few
  ordination axes are taken as directions of change or the main patterns of variance in the
  multivariate data. There is an oft-overlooked issue with this approach that has the potential
  to complicate the interpretation of the extracted axes, especially where there is a single or
  strong gradient in the data.
...
![Three species data from @legendre_numerical_2012 Table 9.7](/assets/img/posts/table-9-7-data.png)
...
![PCA of the three species data from @legendre_numerical_2012 Table 9.7](/assets/img/posts/table-9-7-pca.png)
...
![PCA axis 1 scores for the three species data from @legendre_numerical_2012 Table 9.7](/assets/img/posts/table-9-7-pca1.png)
...
![PCA axis 2 scores for the three species data from @legendre_numerical_2012 Table 9.7](/assets/img/posts/table-9-7-pca2.png)
...
![CA axis 1 and 2 scores for the three species data from @legendre_numerical_2012 Table 9.7](/assets/img/posts/table-9-7-ca-scores.png)
...
![PCA of the Abernethy Forest late glacial pollen sequence [@birks_studies_1978]. The distance biplot focuses on the similarity of the sediment core samples, whilst the species scores are shown as correlations using `scaling = -2`](/assets/img/posts/abernethy-pca-biplot.png)
...
<span>[← Older: New version of permute on CRAN](/2013/12/17/permute-0.8-0-released/)</span>
<span class="text-end">[Newer: Decluttering ordination plots part 4: orditkplot() →](/2013/12/31/decluttering-ordination-in-vegan-part-4-orditkplot/)</span>
:::
