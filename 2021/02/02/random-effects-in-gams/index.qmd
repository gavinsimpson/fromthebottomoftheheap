...
tags:
  ...
  - variance components
category: R
description: "There are lots of choices for fitting generalized linear mixed effects
  models within R, but if you want to include smooth functions of covariates, the
  choices are limited. One option is to fit the model using gamm() from the mgcv \U0001F4E6
  or gamm4() from the gamm4 \U0001F4E6, which use lme() (n…"
