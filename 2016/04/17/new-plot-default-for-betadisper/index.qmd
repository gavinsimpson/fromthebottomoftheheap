...
tags:
  ...
  - Vegan
category: R
description: This weekend, prompted by a pull request from Michael Friendly, I finally
  got round to improving the plot method for betadisper() in the vegan package. betadisper()
  is an implementation of Marti Anderson's Permdisp method, a multivariate analogue
  of Levene's test for homogeneity…
