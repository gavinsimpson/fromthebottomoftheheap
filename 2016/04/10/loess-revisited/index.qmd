...
tags:
  ...
  - Time series
category: Science
description: It's fair to say I have gotten a bee^[an entire hive is perhaps more
  apt!] in my bonnet about how palaeolimnologists handle time. For a group of people
  for whom time is everything, we sure do a poor job (in general) of dealing with
  it in when it comes time to analyse our data. I…
