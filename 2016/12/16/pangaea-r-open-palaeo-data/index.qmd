...
description: >-
  For a while now, I've been wanting to experiment with rOpenSci's pangaear package
  [\@pangaear-024], which allows you to search, and download data from, the Pangaea, a major data
  repository for the earth and environmental sciences. Earlier in the year, as a member of the
  editorial board of Scientific Data, Springer Nature's open data journal I was handling a data
  descriptor submission that described a new 2,200-year foraminiferal &delta;^^18^^O record from
  the Gulf of Taranto in the Ionian Sea [\@Taricco2016-pv]. The data descriptor was recently
  published and as part of the submission Carla Taricco deposited the data set in Pangaea. So,
  what better opportunity to test out pangaear? (Oh and to fit a GAM to the data while I'm at
  it!)
...
#### Tagged
[Pangaea](/tag/pangaea/){.badge .text-bg-dark}
[pangaear](/tag/pangaear/){.badge .text-bg-dark}
[R packages](/tag/r-packages/){.badge .text-bg-dark}
...
[open data](/tag/open-data/){.badge .text-bg-dark}
[palaeo](/tag/palaeo/){.badge .text-bg-dark}
:::
...
![The &delta;^^18^^O record of Taricco *et al* (2016)](/assets/img/posts/simultaneous-intervals-revisited-plot-data-1.png)
...
![Diagnostic plots for the fitted GAM](/assets/img/posts/simultaneous-intervals-revisited-gam-check-1.png)
...
![Observed &delta;^^18^^O values with the fitted trend and 95% point-wise confidence interval superimposed](/assets/img/posts/simultaneous-intervals-revisited-final-plot-1.png)
...
<span>[← Older: Simultaneous intervals for smooths revisited](/2016/12/15/simultaneous-interval-revisited/)</span>
<span class="text-end">[Newer: Modelling extremes using generalized additive models →](/2017/01/25/modelling-extremes-with-gams/)</span>
:::
