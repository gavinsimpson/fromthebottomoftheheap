...
description: >-
  ...
  trend to the then-current Hadley Centre/CRU global temperature time series data set. Since then
  the media and scientific papers have been full of reports of record warm temperatures in the
  past couple of years, of controversies (imagined) regarding data-changes to suit the hypothesis
  of human induce global warming, and the brouhaha over whether global warming had stalled; the
  great global warming hiatus or pause. So it seemed like a good time to revisit that analysis
  and update it using the latest HadCRUT data.
...
[HadCRUT](/tag/hadcrut/){.badge .text-bg-dark}
[Splines](/tag/splines/){.badge .text-bg-dark}
[Global temperatures](/tag/global-temperatures/){.badge .text-bg-dark}
[Climate change](/tag/climate-change/){.badge .text-bg-dark}
:::
...
![HadCRUT4 global mean temperature anomaly](/assets/img/posts/additive-modeling-global-temperature-series-revisited-plot-temperature-data-1.png)
...
![Autocorrelation function of residuals from the additive model with AR(1) errors](/assets/img/posts/additive-modeling-global-temperature-series-revisited-plot-acf-1.png)
...
![Estimated trend in global mean temperature plus 95% simultaneous confidence interval](/assets/img/posts/additive-modeling-global-temperature-series-revisited-plot-fitted-trend-1.png)
...
![50 random simulated trends drawn from the posterior distribution of the fitted model](/assets/img/posts/additive-modeling-global-temperature-series-revisited-plot-simulations-1.png)
...
![50 random simulated trends drawn from the posterior distribution of the fitted model: 1995--2015](/assets/img/posts/additive-modeling-global-temperature-series-revisited-plot-simulations-pause-period-1.png)
...
![First derivative of the fitted trend plus 95% simultaneous confidence interval](/assets/img/posts/additive-modeling-global-temperature-series-revisited-plot-derivatives-1.png)
...
![Kernel density estimates of the first derivative of posterior simulations from the fitted trend model for selected years](/assets/img/posts/additive-modeling-global-temperature-series-revisited-derivatives-per-year-1.png)
...
![Dotplot showing the minimum first derivative over 10,000 posterior simulations from the fitted additive model](/assets/img/posts/additive-modeling-global-temperature-series-revisited-min-sim-derivative-1.png)
...
![Kernel density estimates of the first derivative of posterior simulations from the fitted trend model for selected years. The colour of each density estimate differentiates individual years](/assets/img/posts/additive-modeling-global-temperature-series-revisited-derivatives-single-panel-1.png)
...
<span>[← Older: Better use of transfer functions?](/2015/12/16/agu-transfer-functions/)</span>
<span class="text-end">[Newer: Soap-film smoothers & lake bathymetries →](/2016/03/27/soap-film-smoothers/)</span>
:::
...
opts_chunk$set(results = "hold",
               fig.path = "additive-modeling-global-temperature-series-revisited-", 
               comment = NA,
               prompt = FALSE,
               cache = TRUE,
               cache.path = "../_knitr-cache/additive-modeling-global-temperature-series-revisited.md", 
               fig.show = "hold",
               dev = "png",
               dpi = 85,
               tidy = FALSE,
...
```{r plot-simulations-pause-period}
#| eval: false
#| echo: false
#| output: false
#| include: false
