...
tags:
  ...
  - Canada
category: Science
image: /assets/img/posts/my-trusty-copy-of-the-grid.jpg
description: >-
  For the last three years I have been a member of NSERC's Discovery Grant Evaluation Group for
  Ecology and Evolution (that's 1503 in NSERC-speak). In that time I've evaluated over 130
  Discovery Grant submissions, read the same number of Canadian CCVs, and even chaired a few
  evaluations. This is what I learned, through this process, about writing a successful Discovery
  Grant.
...
[Discovery Grant](/tag/discovery-grant/){.badge .text-bg-dark}
[Grants](/tag/grants/){.badge .text-bg-dark}
[Ecology](/tag/ecology/){.badge .text-bg-dark}
[HQP](/tag/hqp/){.badge .text-bg-dark}
[Canada](/tag/canada/){.badge .text-bg-dark}
:::
...
![My copy of *The Grid* from the 2020 Discovery Grant Competition week in Ottawa, February 2020](/assets/img/posts/my-trusty-copy-of-the-grid.jpg)
...
<span>[← Older: Pivoting tidily](/2019/10/25/pivoting-tidily/)</span>
<span class="text-end">[Newer: Rendering your README with GitHub Actions →](/2020/04/30/rendering-your-readme-with-github-actions/)</span>
:::
