...
tags:
  ...
  - package
category: R
image: /assets/img/posts/gratia-0-4-1-release-plot-difference-smooths-1.png
description: >-
  After a slight snafu related to the 1.0.0 release of dplyr, a new version of gratia is out and
  available on CRAN. This release brings a number of new features, including differences of
  smooths, partial residuals on partial plots of univariate smooths, and a number of utility
  functions, while under the hood gratia works for a wider range of models that can be fitted by
  mgcv.
...
![Partial plots of estimated smooth functions with partial residuals](/assets/img/posts/gratia-0-4-1-release-partial-residuals-1.png)
...
![Gu and Wahba four term additive example functions](/assets/img/posts/gratia-0-4-1-release-data-sim-1.png)
...
![Differences between estimated smooth functions](/assets/img/posts/gratia-0-4-1-release-plot-difference-smooths-1.png)
...
<span>[← Older: Rendering your README with GitHub Actions](/2020/04/30/rendering-your-readme-with-github-actions/)</span>
<span class="text-end">[Newer: Extrapolating with B splines and GAMs →](/2020/06/03/extrapolating-with-gams/)</span>
:::
