...
description: As a developer on the vegan package for R, one of the most FAQs is how
  to customise ordination "Ordination") diagrams, usually to colour the sample points
  according to an external grouping variable. Now, just because we get asked how to
  do this a lot is not really a reflection o…
