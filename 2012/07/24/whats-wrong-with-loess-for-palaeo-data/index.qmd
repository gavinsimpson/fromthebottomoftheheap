...
description: Locally weighted scatterplot smoothing (LOWESS) or local regression (LOESS)
  is widely used to highlight "signal" in variables from stratigraphic sequences.
  It is a user-friendly way of fitting a local model that derives its form from the
  data themselves rather than having to be …
...
![Three LOESS fits to the example data using span = 0.75, 0.25 and 0.5](/assets/img/posts/loess_span_examples.png)
...
![LOESS fit using optimal value of \\( \\lambda \\)](/assets/img/posts/loess_gcv_fit.png)
...
<span>[← Older: Sometimes I am lost for words...](/2012/07/17/sometimes-i-am-lost-for-words/)</span>
<span class="text-end">[Newer: Processing sample labels using regular expressions in R →](/2012/08/15/processing-sample-labels-using-regular-expressions-in-r/)</span>
:::
