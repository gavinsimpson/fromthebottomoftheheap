...
excerpt: In the past few days I've come across two advertorials (articles or editorials
  ...
  today.
description: In the past few days I've come across two advertorials (articles or editorials
  if I'm being generous) from Elsevier in the context of newsletters sent to editors
  and authors. Here I consider the one sent to editors that Ross Mounce (\@rossmounce)
  tweeted about earlier today.
