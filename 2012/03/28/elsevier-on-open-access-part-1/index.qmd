...
tags:
  ...
  - Science
category: Science
excerpt: In the past few days I've come across two advertorials (articles or editorials
  if I'm being generous) from Elsevier in the context of newsletters sent to editors
  and authors. Here I consider the [one sent to editors](http://editorsupdate.elsevier.com/2012/03/copyright-in-an-open-access-world/) that
  Ross Mounce ([\@rossmounce](https://twitter.com/#!/rmounce)) tweeted about earlier
  today.
date: 2012-03-28 12:00:00
description: >-
  In the past few days I've come across two advertorials (articles or editorials if I'm being
  generous) from Elsevier in the context of newsletters sent to editors and authors. Here I
  consider the one sent to editors that Ross Mounce (\@rossmounce) tweeted about earlier today.
...
#### Tagged
[Budapest Open Access Initiative](/tag/budapest-open-access-initiative/){.badge .text-bg-dark}
[CC BY](/tag/cc-by/){.badge .text-bg-dark}
[Copyright](/tag/copyright/){.badge .text-bg-dark}
[Creative Commons licenses](/tag/creative-commons-licenses/){.badge .text-bg-dark}
[Elsevier](/tag/elsevier/){.badge .text-bg-dark}
[Open Access](/tag/open-access/){.badge .text-bg-dark}
[Open access journal](/tag/open-access-journal/){.badge .text-bg-dark}
...
<span>[← Older: I signed the Elsevier boycott pledge](/2012/03/06/i-signed-the-elsevier-boycott-pledge/)</span>
<span class="text-end">[Newer: Elsevier on Open Access part 2 →](/2012/03/31/elsevier-on-open-access-part-2/)</span>
:::
