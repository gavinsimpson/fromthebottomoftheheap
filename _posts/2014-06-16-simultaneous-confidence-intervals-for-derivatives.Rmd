...
```{r plot-deriv-ci-by-hand, fig="hold", results="hide", fig.cap="First derivative of the trend spline from the CET time series additive model. The red dashed lines enclose the 95% simultaneous confidence interval. Superimposed are the first derivatives of the splines for 20 randomly selected posterior simulations from the fitted spline.", fig.height = 3.75}
set.seed(76)
