...
![50 draws from the posterior distribution of the first derivative of the fitted spline.]({{ site.url }}/assets/img/posts/simultaneous-intervals-for-derivatives-of-smooths-plot-sample-of-derivs-1.png)
