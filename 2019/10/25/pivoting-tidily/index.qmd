...
tags:
  ...
  - pivoting
category: R
image: /assets/img/posts/pivoting-tidily-plot-1.png
description: >-
  One of the fun bits of my job is that I have actual time dedicated to helping colleagues and
  grad students with statistical or computational problems. Recently I've been helping one of our
  Lab Instructors with some data that from their Plant Physiology Lab course. Whilst I was
  writing some R code to import the raw data for the lab from an Excel sheet, it occurred to me
  that this would be a good excuse to look at the new pivotlonger() and pivotwider() functions
  from the tidyr package. In this post I show how these new functions facilitate common data
  processing steps; I was personally surprised how little data wrangling was actually needed in
  the end to read in the data from the lab.
...
#### Tagged
[data](/tag/data/){.badge .text-bg-dark}
[data processing](/tag/data-processing/){.badge .text-bg-dark}
[data wrangling](/tag/data-wrangling/){.badge .text-bg-dark}
[pivot tables](/tag/pivot-tables/){.badge .text-bg-dark}
[import](/tag/import/){.badge .text-bg-dark}
[tidyr](/tag/tidyr/){.badge .text-bg-dark}
[tidyverse](/tag/tidyverse/){.badge .text-bg-dark}
[pivoting](/tag/pivoting/){.badge .text-bg-dark}
:::
...
![The pea plants from the 2019 Plant Physiology Lab course, toward the end of the experimental period](/assets/img/posts/plant-phys-plants-in-growth-room.jpg)
...
![Raw data in the Excel Workbook](/assets/img/posts/pivoting-tidily-raw-data.png)
...
![Examples of *wide* and *long* representations of the same data. Source: Garrick Aden-Buie's ([\@grrrck](https://twitter.com/grrrck)) [Tidy Animated Verbs](https://github.com/gadenbuie/tidyexplain)](/assets/img/posts/original-dfs-tidy.png)
...
![Pivoting between *wide* and *long* representations of the same data. Source: Garrick Aden-Buie's ([\@grrrck](https://twitter.com/grrrck)) [Tidy Animated Verbs](https://github.com/gadenbuie/tidyexplain) modified by Mara Averick ([\@dataandme](https://twitter.com/dataandme))](/assets/img/posts/tidyr-longer-wider.gif)
...
![Plot of the plant growth data](/assets/img/posts/pivoting-tidily-plot-1.png)
...
<span>[← Older: radian: a modern console for R](/2019/06/18/radian-console-for-r/)</span>
<span class="text-end">[Newer: What evaluating Discovery Grants for the last three years has taught me →](/2020/02/26/what-three-years-evaluating-discovery-grants-taught-me/)</span>
:::
...
opts_chunk$set(results = "hold",
               fig.path = "pivoting-tidily-", 
               comment = NA,
               prompt = FALSE,
               cache = FALSE,
               cache.path = "../_knitr-cache/pivoting-tidily-", 
               fig.show = "hold",
               dev = "png",
               dpi = 85,
               tidy = FALSE,
