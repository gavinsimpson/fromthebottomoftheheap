...
# Copyright (c) 2016 Gavin Simpson, http://www.fromthebottomoftheheap.net/ (modifications for tags)
...
#
# Included filters :
# - tags_links:      Outputs the list of categories as comma-separated <a> links.
# - date_to_html_string: Outputs the post.date as formatted html, with hooks for CSS styling.
#
# Available _config.yml settings :
# - tag_dir:          The subfolder to build category pages in (default is 'tags').
# - tag_title_prefix: The string used before the category name in the page title (default is
#                          'Tag: ').
module Jekyll

  # The TagIndex class creates a single tag page for the specified category.
  class TagPage < Page
