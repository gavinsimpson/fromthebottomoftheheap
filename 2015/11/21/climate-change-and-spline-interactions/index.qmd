...
description: >-
  In a series of irregular posts[^3] I've looked at how additive models can be used to fit
  non-linear models to time series. Up to now I've looked at models that included a single
  non-linear trend, as well as a model that included a within-year (or seasonal) part and a trend
  part. In this trend plus season model it is important to note that the two terms are purely
  additive; no matter which January you are predicting for in a long timeseries, the seasonal
  effect for that month will always be the same. The trend part might shift this seasonal
  contribution up or down a bit, but all January's are the same. In this post I want to introduce
  a different type of spline interaction model that will allow us to relax this additivity
  assumption and fit a model that allows the seasonal part of the model to change in time along
  with the trend.
...
[Interactions](/tag/interactions/){.badge .text-bg-dark}
:::
...
![ACF for model `m0` a naive additive model assuming conditional independence of observations fitted to the CET time series](/assets/img/posts/climate-change-and-spline-interactions-plot-naive-acf-1.png) 
...
![ACF for model `m7` an additive model with an AR(7) process in the residuals fitted to the CET time series](/assets/img/posts/climate-change-and-spline-interactions-plot-best-acf-1.png) 
...
![Fitted bivariate spline](/assets/img/posts/climate-change-and-spline-interactions-plot-gam-1.png) 
...
![Predicted monthly temperature for 1914 and 2014](/assets/img/posts/climate-change-and-spline-interactions-predict-plot-1-1.png) 
...
![Predicted trends in monthly temperature, 1914--2014.](/assets/img/posts/climate-change-and-spline-interactions-predict-plot-2-1.png) 
...
![Predicted trends in monthly temperature, 1914--2014, by quarter.](/assets/img/posts/climate-change-and-spline-interactions-predict-plot-3-1.png) 
...
<span>[← Older: User-friendly scaling](/2015/10/08/user-friendly-scaling/)</span>
<span class="text-end">[Newer: Are some seasons warming more than others? →](/2015/11/23/are-some-seasons-warming-more-than-others/)</span>
:::
...
opts_chunk$set(results = "hold",
               fig.path = "climate-change-and-spline-interactions-", 
               comment = NA,
               prompt = FALSE,
               cache = TRUE,
               cache.path = "../_knitr-cache/climate-change-and-spline-interactions-", 
               fig.show = "hold",
               dev = "png",
               dpi = 85,
               tidy = FALSE,
