...
description: >-
  I ended the last post with some pretty plots of air temperature change within and between years
  in the Central England Temperature series. The elephant in the room^[well, one of the
  elephants; I also wasn't happy with the AR(7) for the residuals] at the end of that post was is
  the change in the within year (seasonal) effect over time statistically significant? This is
  the question I'll try to answer, or at least show how to answer, now.
...
The model we ended up with was the spline interaction with an AR(7) in the residuals. To catch you up, the chunk below loads the CET data and fits the model we were left with at the end of the [previous post](/2015/11/21/climate-change-and-spline-interactions/)
...
![Difference in monthly temperature predictions between 1914 and 2014](/assets/img/posts/are-some-seasons-warming-more-than-others-plot-1-1.png) 
...
![Smooths for the spline interaction model including a tensor product interaction smooth](/assets/img/posts/are-some-seasons-warming-more-than-others-plot-smooths-1.png) 
...
<span>[← Older: Climate change and spline interactions](/2015/11/21/climate-change-and-spline-interactions/)</span>
<span class="text-end">[Newer: AGU Fall Meeting 2015 →](/2015/12/14/agu-2015-poster/)</span>
:::
