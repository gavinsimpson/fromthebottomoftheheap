...
tags:
  ...
  - Interactions
category: R
description: I ended the last post with some pretty plots of air temperature change
  within and between years in the Central England Temperature series. The elephant
  in the room^[well, one of the elephants; I also wasn't happy with the AR(7) for
  the residuals] at the end of that post was is t…
