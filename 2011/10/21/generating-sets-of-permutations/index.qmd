...
description: >-
  In previous posts I discussed how to generate a single permutation from a fully-randomised or
  restricted permutation design using shuffle(). Here I want to briefly mention the shuffleSet()
