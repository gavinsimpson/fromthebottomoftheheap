...
description: In a previous post I introduced the permute package and the function
  shuffle(). In that post I got as far as replicating R's base function sample().
  Here I'll briefly outline how shuffle() can be used to generate restricted permutations.
...
[randomisation](/tag/randomisation/){.badge .text-bg-dark}
...
<span>[← Older: permute: a package for generating restricted permutations](/2011/10/04/permute-a-package-for-generating-restricted-permutations/)</span>
<span class="text-end">[Newer: Generating sets of permutations →](/2011/10/21/generating-sets-of-permutations/)</span>
:::
