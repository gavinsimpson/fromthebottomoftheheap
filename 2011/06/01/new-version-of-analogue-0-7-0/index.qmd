...
tags:
  ...
  - R
category: R
excerpt: Last week I pushed an update of my [analogue](http://analogue.r-forge.r-project.org/
  'analogue website') package to [CRAN](http://cran.at.r-project.org/web/packages/analogue/index.html
  'analogue page on CRAN'). The last release (0.6-23) was on CRAN sometime in Mar
  2010 so an update was well overdue.
description: Last week I pushed an update of my analogue package to CRAN. The last
  release (0.6-23) was on CRAN sometime in Mar 2010 so an update was well overdue.
...
Last week I pushed an update of my [analogue](http://analogue.r-forge.r-project.org/ 'analogue website') package to [CRAN](http://cran.at.r-project.org/web/packages/analogue/index.html 'analogue page on CRAN'). The last release (0.6-23) was on CRAN sometime in Mar 2010 so an update was well overdue.
...
<span>[← Older: Minor update to Vegan (1.17-10)](/2011/06/01/minor-update-to-vegan-1-17-10/)</span>
<span class="text-end">[Newer: Stratigraphic diagrams using analogue →](/2011/06/08/stratigraphic-diagrams-using-analogue/)</span>
:::
