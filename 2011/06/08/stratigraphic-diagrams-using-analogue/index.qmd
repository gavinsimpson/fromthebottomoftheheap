...
tags:
  ...
  - R
category: R
excerpt: One of the routine tasks palaeoecologists do is plot data on species composition
  or geochemical proxies say along a sediment core or stratigraphic sequence. These
  diagrams are the canonical way of displaying stratigraphic data in this field. An
  example of a stratigraphic diagram is shown below.
description: One of the routine tasks palaeoecologists do is plot data on species
  composition or geochemical proxies say along a sediment core or stratigraphic sequence.
  These diagrams are the canonical way of displaying stratigraphic data in this field.
  An example of a stratigraphic diagram…
...
![Example of a stratigraphic diagram showing data from the classic Abernethy Forest late glacial pollen sequence](/assets/img/posts/stratigraphic_plot.png "Stratigraphic plot example")
...
![Stratigraphic diagram of the Abernethy Forest pollen sequence with taxa sorted by WA of the Age variable](/assets/img/posts/stratigraphic_plot_wa_sort.png "Stratigraphic diagram with taxa sorted by WA of the Age variable")
...
![Stratigraphic diagram of the Abernethy Forest pollen sequence with taxa sorted by WA and six zones superimposed](/assets/img/posts/stratigraphic_plot_zones.png?w=300 "Stratigraphic plot with zones")
...
<span>[← Older: New version of analogue (0.7-0)](/2011/06/01/new-version-of-analogue-0-7-0/)</span>
<span class="text-end">[Newer: What is ordisurf() doing...? →](/2011/06/10/what-is-ordisurf-doing/)</span>
:::
