...
tags:
  ...
  - Time series
category: R
alert: <strong>Updated</strong> The URL to the HadCRUT3v data set changed following
  the release of version 4 of the data set (12 January 2015).
date: 2011-06-12 12:00:00
description: >-
  (If the download code above doesn't work for you &mdash; it does on my Linux machine &mdash;
  then download the files using your browser and source() in the usual way.) Next, load the data
  and process the file as per the earlier post (see here for details). The last lines of code
  plot the data (note that I only intend to use the annual means in this posting — dealing with
  monthly data needs a few extra steps to model the seasonal variation in the data).
...
![Global mean temperature anomaly 1850-2010](/assets/img/posts/global_HadCRUT3v_time_series.png "Global mean temperature anomaly 1850-2010")
...
![Fitted thin-plate spline with AR(1) residuals and approximate 95% point-wise confidence interval](/assets/img/posts/fitted_gamm_ar1_smooth_plot.png "Fitted thin-plate spline with AR(1) residuals and approximate 95% point-wise confidence interval")
...
![Diagnostic plots for the fitted model using AR(1) residuals fitted to the 1850–2010 global mean annual temperature data](/assets/img/posts/fitted_gamm_ar1_diagnostics.png "Diagnostic plots for the fitted model using AR(1) residuals fitted to the 1850–2010 global mean annual temperature data")
...
![Comparison of the two fitted additive models](/assets/img/posts/comparison_of_gamm_models.png "Comparison of fitted additive models")
...
(increasing)](/assets/img/posts/derivatives_of_fitted_model.png "First derivatives of the additive model with AR(1) errors.")
...
![Fitted additive model with AR(1) errors and superimposed periods of significant change in temperature](/assets/img/posts/fitted_additive_model_plus_derivatives.png "Fitted additive model with AR(1) errors and superimposed periods of significant change in temperature")
...
![50 simulated trends from the fitted additive model for the period 1990&ndash;2010](/assets/img/posts/simulated_trends_recent_period.png "50 simulated trends from the fitted additive model for the period 1990–2010")
...
<span>[← Older: Global warming since 1995 'now significant'](/2011/06/11/global-warming-since-1995-now-significant/)</span>
<span class="text-end">[Newer: Embedding a time series with time delay in R &mdash; Part II →](/2011/06/14/embedding-a-time-series-with-time-delay-in-r-part-ii/)</span>
:::
