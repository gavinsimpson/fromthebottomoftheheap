...
description: >-
  Yesterday Jari packaged up the latest release in the current stable branch of the vegan
  package. Version 1.17-9 of vegan is now on CRAN as a source tarball with binaries for MS
  Windows and MacOS X to follow soon.
