---
title: Controls on subannual variation in pCO<sub>2</sub> in productive hardwater
  lakes
tags:
  - papers
  - pCO2
...
image: /assets/img/posts/wiik-et-al-2018-figure-4.png
description: >-
  This year is looking like a bumper year for papers from the lab and collaborations, past and
  ongoing. Over the summer hiatus three papers came out online in their version-of-record form.
  The first of these was a paper on work that Emma Wiik, a former postdoc in my lab and Peter
  Leavitt's lab, conducted to further our research on the controls on CO~2~ exchange between
...
#### Tagged
[papers](/tag/papers/){.badge .text-bg-dark}
[pCO2](/tag/pco2/){.badge .text-bg-dark}
[CO2](/tag/co2/){.badge .text-bg-dark}
[GAM](/tag/gam/){.badge .text-bg-dark}
[lakes](/tag/lakes/){.badge .text-bg-dark}
[climate](/tag/climate/){.badge .text-bg-dark}
[hardwater](/tag/hardwater/){.badge .text-bg-dark}
[timeseries](/tag/timeseries/){.badge .text-bg-dark}
[DIC](/tag/dic/){.badge .text-bg-dark}
[pH](/tag/ph/){.badge .text-bg-dark}
:::


This year is looking like a bumper year for papers from the lab and collaborations, past and ongoing. Over the [summer hiatus](/2018/10/15/summer-hiatus/) three papers came out online in their version-of-record form. The first of these was a paper on work that Emma Wiik, a former postdoc in my lab and Peter Leavitt's lab, conducted to further our research on the controls on CO~2~ exchange between lakes and the atmosphere.
...
![Figure 4 from the paper. (a–c) GAM partial effect splines for significant metabolic variables. Dotted lines: means of $y$ and $x$; Shaded area: middle 90% of all observations. Rug: data points. (a) GAM splines for chlorophyll a, with lakes with significantly different splines to the global spline indicated by color/hue and linetype. (b) GAM spline of oxygen, with standard errors indicated by shading. (c) GAM spline of dissolved organic carbon, with standard errors indicated by shading.](/assets/img/posts/wiik-et-al-2018-figure-4.png "Figure 4 from Wiik et al 2018.")

The paper is available from the [journal website](https://doi.org/10.1029/2018JG004506) or via a [preprint](/assets/reprints/wiik-2018-jgr-b-co2-preprint.pdf) if you do not have access to Journal of Geophysical Research: Biogeosciences.

### References

::: {.post-navigation .d-flex .justify-content-between .gap-3}
<span>[← Older: Summer hiatus](/2018/10/15/summer-hiatus/)</span>
<span class="text-end">[Newer: Introducing gratia →](/2018/10/23/introducing-gratia/)</span>
:::
