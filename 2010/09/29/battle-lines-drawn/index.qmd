...
description: >-
  I'd been pondering what to write for my first foray into the blog-o-sphere. Several ideas were
  milling about my head but for some reason I never got round to putting fingers to keyboard. But
  the weekly newsletter from the UCL Provost has spurred me to action...
...
[Funding](/tag/funding/){.badge .text-bg-dark}
...
<span></span>
<span class="text-end">[Newer: Why I love open source! →](/2010/12/03/why-i-love-open-source/)</span>
:::
