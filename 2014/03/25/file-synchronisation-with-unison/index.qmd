...
description: >-
  It's becoming a fairly common experience to work on two or more computing devices; say a
  desktop/workstation in the office and a laptop when travelling or a home desktop. Which is
  great, but how do you keep all those machines in sync so that you have the latest versions of
  your files available no matter where you need to work?
...
#### Posted in
[Computing](/category/computing/){.badge .text-bg-warning}

#### Tagged
[Sync](/tag/sync/){.badge .text-bg-dark}
[Backup](/tag/backup/){.badge .text-bg-dark}
[Files](/tag/files/){.badge .text-bg-dark}
:::
...
<ul class="list-unstyled float-start me-3 ftboth-img-right">
<li class="col-md-3">
<div class="border rounded p-1">
<img src="/assets/img/posts/unison.gif">
...
glory](/assets/img/posts/unison-example-screengrab.png)
...
<span>[← Older: Summarising multivariate palaeoenvironmental data](/2014/01/09/pcurve-part-2/)</span>
<span class="text-end">[Newer: Modelling seasonal data with GAMs →](/2014/05/09/modelling-seasonal-data-with-gam/)</span>
:::
