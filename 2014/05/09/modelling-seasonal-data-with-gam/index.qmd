...
description: >-
  In previous posts (here and here) I have looked at how generalized additive models (GAMs) can
  be used to model non-linear trends in time series data. At the time a number of readers
  commented that they were interested in modelling data that had more than just a trend
  component; how do you model data collected throughout the year over many years with a GAM? In
  this post I will show one way that I have found particularly useful in my research.
...
![CET annual average temperature time series](/assets/img/posts/modelling-seasonal-data-with-gam-plot-cet.png) 
...
![Cubic spline basis functions](/assets/img/posts/modelling-seasonal-data-with-gam-plot-cubic-spline-example.png) 
...
![Cyclic cubic spline basis functions](/assets/img/posts/modelling-seasonal-data-with-gam-plot-cyclic-cubic-spline-example.png) 
...
![Smooth terms for the naive model assuming uncorrelated errors](/assets/img/posts/modelling-seasonal-data-with-gam-plot-naive-model.png) 
...
![ACF and pACF of the residuals from the naive model](/assets/img/posts/modelling-seasonal-data-with-gam-plot-naive-model-residuals.png) 
...
![Smooth terms for the best fitting GAM model with AR(2)](/assets/img/posts/modelling-seasonal-data-with-gam-plot-ar2-model-terms.png) 
...
![ACF and pACF of the residuals from the GAM model with AR(2) correlation matrix](/assets/img/posts/modelling-seasonal-data-with-gam-acf-residuals-ar2-model.png) 
...
![Comparison of the fitted trend components for the four models considered](/assets/img/posts/modelling-seasonal-data-with-gam-plot-model-trends.png) 
...
<span>[← Older: File synchronisation with Unison](/2014/03/25/file-synchronisation-with-unison/)</span>
<span class="text-end">[Newer: Identifying periods of change in time series with GAMs →](/2014/05/15/identifying-periods-of-change-with-gams/)</span>
:::
...
```{r setup-cyclic-cubic-spline-basis}
#| eval: false
#| echo: false
#| output: false
#| include: false
...
```{r plot-cyclic-cubic-spline-example}
#| eval: false
#| echo: false
#| output: false
#| include: false
...
```{r fit-amms-with-correlated-errors}
#| eval: false
#| echo: false
#| output: false
#| include: false
