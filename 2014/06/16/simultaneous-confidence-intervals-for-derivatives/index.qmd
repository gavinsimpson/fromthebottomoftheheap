...
description: >-
  To get a headstart on this, I'll reuse the model we fitted to the CET time series from the
  previous post. Just copy and paste the code below into your R session
