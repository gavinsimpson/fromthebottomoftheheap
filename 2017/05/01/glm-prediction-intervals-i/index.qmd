...
category: R
description: >-
  One of my more popular answers on StackOverflow concerns the issue of prediction intervals for
  a generalized linear model (GLM). My answer really only addresses how to compute confidence
  intervals for parameters but in the comments I discuss the more substantive points raised by
  the OP in their question. Lately there's been a bit of back and forth between Jarrett Byrnes
  and myself about what a prediction "interval" for a GLM might mean. Comments, even on
  StackOverflow, aren't a good place for a discussion so I thought I'd post something here that
  went into a bit more detail as to why, for some common types of GLMs, prediction intervals
  aren't that useful and require a lot more thinking about what they mean and how they should be
  calculated. For illustration, I thought I'd use some small teaching example data sets, but
  whilst writing the post it started to get a little on the long side. So, I've broken it into
  two and in this part I look at logistic regression.
...
[prediction interval](/tag/prediction-interval/){.badge .text-bg-dark}
[statistical modelling](/tag/statistical-modelling/){.badge .text-bg-dark}
[logistic regression](/tag/logistic-regression/){.badge .text-bg-dark}
:::
...
![Kernel density estimates of the distribution of heights of leaves visited or not by wasps.](/assets/img/posts/glm-prediction-intervals-i-load-packages-plot-darlingtonia-1.png)
...
![Estimated probability of visitation plus pointwise 95% confidence interval.](/assets/img/posts/glm-prediction-intervals-i-fitted-function-and-ci-1.png)
...
<span>[← Older: Simultaneous intervals for derivatives of smooths revisited](/2017/03/21/simultaneous-intervals-for-derivatives-of-smooths/)</span>
<span class="text-end">[Newer: Prediction intervals for GLMs part II →](/2017/05/01/glm-prediction-intervals-ii/)</span>
:::
...
```{r load-packages-plot-darlingtonia}
#| eval: false
#| echo: false
#| output: false
#| include: false
