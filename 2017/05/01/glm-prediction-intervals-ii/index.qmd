...
description: >-
  ...
  a generalized linear model (GLM). Comments, even on StackOverflow, aren't a good place for a
  discussion so I thought I'd post something hereon my blog that went into a bit more detail as
  to why, for some common types of GLMs, prediction intervals aren't that useful and require a
  lot more thinking about what they mean and how they should be calculated. I've broken it into
  two and in this, the second part, I look at Possion models.
...
[offset](/tag/offset/){.badge .text-bg-dark}
...
![The fitted GAM for the common whitethroat data, showing the estimated number of breeding pairs per hectare with a 95% pointwise confidence interval. The points are the observed densities of breeding pairs.](/assets/img/posts/glm-prediction-intervals-ii-plot-wildflowers-1.png)
...
![](/assets/img/posts/glm-prediction-intervals-ii-implied-poisson-distributions-1.png)
...
<span>[← Older: Prediction intervals for GLMs part I](/2017/05/01/glm-prediction-intervals-i/)</span>
<span class="text-end">[Newer: Fitting count and zero-inflated count GLMMs with mgcv →](/2017/05/04/compare-mgcv-with-glmmTMB/)</span>
:::
...
```{r implied-poisson-distributions}
#| eval: false
#| echo: false
#| output: false
#| include: false
