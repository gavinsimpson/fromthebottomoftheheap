...
category: R
description: >-
  One of the really appealing features of the mgcv package for fitting GAMs is the functionality
  it exposes for fitting quite complex models, models that lie well beyond what many of us may
  have learned about what GAMs can do. One of those features that I use a lot is the ability to
  model the smooth effects of some covariate $x$ in the different levels of a factor. Having
  estimated a separate smoother for each level of the factor, the obvious question is, which
  smooths are different? In this post I'll take a look at one way to do this using by-variable
  smooths.
...
![](/assets/img/posts/difference-smooths-i-plot-data-1.png)
...
![Estimated smooths for each level of factor `SiteCode`](/assets/img/posts/difference-smooths-i-plot-smooths-1.png)
...
![Estimated differences of trends in sediment Hg concentration for pairs of Scottish lochs](/assets/img/posts/difference-smooths-i-plot-difference-smmoths-1.png)
...
<span>[← Older: Fitting count and zero-inflated count GLMMs with mgcv](/2017/05/04/compare-mgcv-with-glmmTMB/)</span>
<span class="text-end">[Newer: First steps with MRF smooths →](/2017/10/19/first-steps-with-mrf-smooths/)</span>
:::
