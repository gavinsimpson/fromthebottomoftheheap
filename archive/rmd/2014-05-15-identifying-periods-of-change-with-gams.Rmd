...
```{r fit-ar2-model, results="hide", prompt=FALSE}
...
```{r load-derivatives-gist, prompt = FALSE}
...
```{r plot-trend-with-sizer, fig="hold", echo=TRUE, results="hide", fig.cap="Fitted trend showing periods of significant increase in temperature in blue.", fig.height = 4.5}
...
```{r plot-trend-with-sizer-and-data, fig="hold", echo=TRUE, results="hide", fig.cap="Fitted trend showing periods of significant increase in temperature in blue. The original data are shown as grey points. Note the low precision of the data early in the CET series.", fig.height = 4.5}
