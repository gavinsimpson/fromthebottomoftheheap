...
```{r plot-naive-acf, fig.height = 5, fig.cap = "ACF for model `m0` a naive additive model assuming conditional independence of observations fitted to the CET time series"}
...
```{r plot-best-acf, fig.height = 5, fig.cap = "ACF for model `m7` an additive model with an AR(7) process in the residuals fitted to the CET time series"}
...
```{r plot-gam, fig.cap = "Fitted bivariate spline"}
...
```{r predict-plot-1, fig.cap = "Predicted monthly temperature for 1914 and 2014"}
...
```{r predict-plot-2, fig.cap = "Predicted trends in monthly temperature, 1914--2014.", fig.height = 5, fig.width = 10}
...
```{r predict-plot-3, fig.cap = "Predicted trends in monthly temperature, 1914--2014, by quarter."}
