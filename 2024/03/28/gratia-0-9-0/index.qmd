...
tags:
  ...
  - R
category: R
image: /assets/img/posts/gratia-0-9-0-gratia-0-9-0-sos-example-1.png
description: >-
  I am pleased to announce the release of gratia 0.9.0. This release has been over a year in the
  making and provides many new features as well as a more consistent user experience.
  Unfortunately, I have had to make a lot of breaking changes; nothing too egregious, but most
  user-facing functions are affected. This release represents a solid base to move towards gratia
  version 1.0.0. Here, I describe what I broke as well as outline some of the major new features
  in the package.
...
[Generalized additive models](/tag/generalized-additive-models/){.badge .text-bg-dark}
[R package](/tag/r-package/){.badge .text-bg-dark}
...
![Spline on the sphere example, showing estimated spatial effect on ocean surface chlorophyll a.](/assets/img/posts/gratia-0-9-0-gratia-0-9-0-sos-example-1.png)
...
![Plot produced by draw() using grouped_by = TRUE.](/assets/img/posts/gratia-0-9-0-gratia-0-9-0-grouped-by-1.png)
...
<span>[← Older: Using random effects in GAMs with mgcv](/2021/02/02/random-effects-in-gams/)</span>
